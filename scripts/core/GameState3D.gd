...
func _rf_pre_090f_to_save_dict() -> Dictionary:
	return {
		...
		"selected_build_lane_id": selected_build_lane_id,
		"allocated_passive_nodes": allocated_passive_nodes,
		"selected_passive_node_id": selected_passive_node_id,
		"passive_tree_filter": passive_tree_filter,
		"passive_tree_search": passive_tree_search,
		"selected_ascendancy_id": selected_ascendancy_id,
		"ascendancy_points": ascendancy_points,
		"allocated_ascendancy_nodes": allocated_ascendancy_nodes,
		"selected_ascendancy_node_id": selected_ascendancy_node_id,
